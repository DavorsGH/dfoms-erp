...
/**
 * Billing Settings: after Paystack Inline success, verify the charge and
 * credit the tenant SMS wallet. Webhook is the durable path; this is the
 * fast UX path (same pattern as POS MoMo / portal rent confirm).
 */
