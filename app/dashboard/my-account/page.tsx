    ...
    <div className="space-y-6">
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mb-4 text-sm text-slate-600">
          Optional extra protection for your ERP sign-in.
        </p>
        <a
          href="/dashboard/my-account/mfa"
          className="inline-flex rounded-md bg-[#0f2744] px-4 py-2 text-sm font-medium text-white hover:bg-[#1a3a5c]"
        >
