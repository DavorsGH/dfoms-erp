...
export const SITE_SELECT =
  "*, client:customers!sites_client_id_fkey(client_id, client_name), project:projects!sites_project_id_fkey(id, project_code, project_name)";

export const SITE_ASSIGNMENT_SELECT =
  "site_code, site_name, client_id, building, floor_zone, area_room, cleaning_frequency, risk_level, required_staff, project_id, assigned_supervisor, notes, client:customers!sites_client_id_fkey(client_id, client_name), project:projects!sites_project_id_fkey(id, project_code, project_name)";
