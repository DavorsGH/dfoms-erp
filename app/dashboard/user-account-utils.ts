...
export const USER_ACCOUNT_SELECT =
  "auth_uid, employee_id, email, role, is_active, client_id, employees!user_accounts_employee_id_fkey(full_name), clients:customers!user_accounts_client_id_fkey(client_name), user_account_supervisor_sites(site_code)";
