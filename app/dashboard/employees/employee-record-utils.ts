...
export const EMPLOYEE_SELECT =
  "*, department_ref:departments!employees_department_fkey(dept_code, department_name), project_ref:projects!employees_contract_project_fkey(project_code, project_name)";
