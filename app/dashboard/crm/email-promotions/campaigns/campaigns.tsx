        ...
        <section className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span title="Sending will be enabled in the next update">
                <button
                  type="button"
                  disabled
                  className="cursor-not-allowed rounded-md border border-slate-200 bg-slate-100 px-5 py-2 text-sm font-medium text-slate-400"
                >
                  Send
                </button>
              </span>
