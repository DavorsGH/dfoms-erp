...
export default async function LandlordPortalBillingCallbackPage({
  searchParams,
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-sm text-slate-600">
        {success
          ? "Your payment was received. SMS credits will appear once confirmation finishes (inline or webhook). You can return to Billing Settings."
