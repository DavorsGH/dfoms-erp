...
import LandlordPortalNav from "./portal-nav";
...
/**
 * Shared Landlord Portal chrome — same navy header/footer, Davors logo,
 * and wordmark as the Tenant Portal, with "Landlord Portal" subtitle.
 */
