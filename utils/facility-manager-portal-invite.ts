...
function buildFacilityManagerInviteEmailContent(args: {
  ...
  return buildPortalInviteEmail({
    ...
    inviterLine: `${landlordName} has invited you to manage properties on Davors Technologies.`,
    inviteUrl,
    expiryDays: FACILITY_MANAGER_INVITE_EXPIRY_DAYS,
    subject: "You're invited as a Facility Manager — Davors Technologies",
    existingAuthAccount,
    reuseSubject: "Facility Manager access — Davors Technologies",
