...
const sql = readFileSync(
  resolve(process.cwd(), "../../06 Database/81_payment_accounts_momo_merchant_name.sql"),
  "utf8",
);
...
try {
  console.log(
    "Running 81_payment_accounts_momo_merchant_name.sql on PRODUCTION (tvcurcnmasnocwdxzgvz)...",
  );
