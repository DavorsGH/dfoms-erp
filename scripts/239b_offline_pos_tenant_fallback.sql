-- =============================================================================
-- 239b_offline_pos_tenant_fallback.sql
--
-- STAGING: allow sync/resolve RPCs to derive tenant from payload/conflict when
-- current_user_tenant_id() is null (service_role tests / admin tooling).
-- Authenticated app users still prefer current_user_tenant_id().
-- =============================================================================
