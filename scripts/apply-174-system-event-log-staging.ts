/**
 * Apply scripts/174_system_event_log.sql to staging.
 * Usage: npx tsx scripts/apply-174-system-event-log-staging.ts
 */
...
async function main() {
  ...
  try {
    ...
    console.log("OK: applied scripts/174_system_event_log.sql on staging");
